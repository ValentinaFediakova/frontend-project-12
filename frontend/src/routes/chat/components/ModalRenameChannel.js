...
// import { channelRename } from '../../../redux/actions/channels.action'
...
const ModalRenameChannel = ({ show, onClose, nameChannel, idChannel, onChangeNameChannel }) => {
        ...
        <Modal.Body>
          <Form onSubmit={handleRenameChannel} >
            <Form.Group className="mb-3" controlId="exampleForm.ControlInput1">
              <Form.Label>Изменить канал</Form.Label>
              <Form.Control
                isInvalid={!validated}
                type="text"
                name='channelName'
